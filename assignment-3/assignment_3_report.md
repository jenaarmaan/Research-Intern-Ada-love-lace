...
Module 3 Coursework  •  AI Research Labs  •  Research Internship
...
1. **Session 1**: User introduces name ("Armaan"), role ("Research Intern"), project ("Agentic AI project"), and UI preference ("Streamlit").
